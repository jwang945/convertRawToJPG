...
#VARIABLES TO CHANGE
DIRECTORY_NAME = "Primary_TO_JPG"
DIRECTORY_PATH = "/Volumes/Extreme_SSD/1_26_21/" #add path to directory if not in same folder
IMG_HEIGHT = 1080
IMG_WIDTH = 1440
FPS = 30.0
...
out = cv2.VideoWriter(DIRECTORY_NAME[:-7] + ".mp4",cv2.VideoWriter_fourcc('X', 'I', 'V', 'D'), FPS, (IMG_WIDTH,IMG_HEIGHT))
